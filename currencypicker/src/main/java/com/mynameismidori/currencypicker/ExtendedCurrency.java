...
public class ExtendedCurrency {
    public static final ExtendedCurrency[] CURRENCIES_DE = {
            ...
            new ExtendedCurrency("GBP", "Britische Pfund", "£", "", R.drawable.flag_gbp),
            new ExtendedCurrency("DKK", "Dänische Kronen","kr", "", R.drawable.flag_dkk),
            ...
            new ExtendedCurrency("ISK", "Isländische Kronen","kr", "", R.drawable.flag_isk),
            new ExtendedCurrency("CHF", "Schweizer Franken", "CHF", "", R.drawable.flag_chf),
            new ExtendedCurrency("CZK", "Tschechische Koruna", "Kč", "", R.drawable.flag_czk),
            new ExtendedCurrency("PLN", "Polnischer Zloty","zł", "", R.drawable.flag_pln),
            new ExtendedCurrency("RUB", "Russische Ruble", "₽", "", R.drawable.flag_rub),
    ...
    public static ExtendedCurrency getCurrencyByISO(String currencyIsoCode) {
        ...
        for (ExtendedCurrency c : extendedCurrencies) {
