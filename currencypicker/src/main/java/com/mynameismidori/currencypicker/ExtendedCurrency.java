...
public class ExtendedCurrency {
    ...
    private int flag = -1;
    private String flagUrl = ""; // either we have local flag resource, or we have remote URL resource

    public ExtendedCurrency(String code, String name, String symbol, int flag, String flagUrl) {
        this.code = code;
        this.name = name;
        this.symbol = symbol;
        this.flag = flag;
